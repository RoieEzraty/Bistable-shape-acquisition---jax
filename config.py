...
class VariablesConfig:
    ...
    # numerical stability
    contact_scale: float = 6  # max experimental torque and torque upon edge contact ratio, for numerical stability
...
class TrainingConfig:
    T: int = 18  # total training set time (not time to reach equilibrium during every step)
    alpha: float = 0.002  # learning rate
